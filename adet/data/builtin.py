...
_PREDEFINED_SPLITS_NUCLEI = {
    "pannuke_in_mscoco_format_train": ("pannuke_in_mscoco_format_train", "pannuke_in_mscoco_format_train/annotations.json"),
    "pannuke_in_mscoco_format_val": ("pannuke_in_mscoco_format_val", "pannuke_in_mscoco_format_val/annotations.json"),
    "pannuke_in_mscoco_format_test": ("pannuke_in_mscoco_format_test", "pannuke_in_mscoco_format_test/annotations.json")
}
